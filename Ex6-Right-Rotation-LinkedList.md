...
## Result:
Thus, the Java program to perfom right rotation on linked list is implemented successfully.ram to perfom right rotation on linked list is implemented successfully.
